  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="index2.html" class="logo"><b>Site</b>Engineer</a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      <li><!-- start message -->
                        <a href="#">
                          <div class="pull-left">
                            <img src="{{url('public/asset/img/user2-160x160.jpg')}}" class="img-circle" alt="User Image"/>
                          </div>
                          <h4>
                            Support Team
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="{{url('public/asset/img/user3-128x128.jpg')}}" class="img-circle" alt="user image"/>
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="{{url('public/asset/img/user4-128x128.jpg')}}" class="img-circle" alt="user image"/>
                          </div>
                          <h4>
                            Reviewers
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="{{url('public/asset/img/user2-160x160.jpg')}}" class="user-image" alt="User Image"/>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="{{url('admin/addroll')}}"><i class="fa fa-circle-o"></i> Add Roll</a></li>
                <li><a href="{{url('admin/adduser')}}"><i class="fa fa-circle-o"></i> Add User</a></li>
                <li><a href="{{url('admin/show_users')}}"><i class="fa fa-circle-o"></i> Show Users</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
            ...
            <section class="col-lg-7 connectedSortable">
              ...
              <div class="box box-success">
                ...
                <div class="box-body chat" id="chat-box">
                  <!-- chat item -->
                  <div class="item">
                    <img src="{{url('public/asset/img/user4-128x128.jpg')}}" alt="user image" class="online"/>
                    <p class="message">
                      <a href="#" class="name">
                  ...
                  <!-- chat item -->
                  <div class="item">
                    <img src="{{url('public/asset/img/user3-128x128.jpg')}}" alt="user image" class="offline"/>
                    <p class="message">
                      <a href="#" class="name">
                  ...
                  <!-- chat item -->
                  <div class="item">
                    <img src="{{url('public/asset/img/user2-160x160.jpg')}}" alt="user image" class="offline"/>
                    <p class="message">
                      <a href="#" class="name">
